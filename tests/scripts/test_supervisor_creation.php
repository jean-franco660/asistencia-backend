...
/**
 * Script de prueba para verificar la creación de supervisores
 * Simula una petición HTTP POST al endpoint de creación
 */

echo "=== PRUEBA DE CREACIÓN DE SUPERVISOR ===\n\n";
...
echo "Resultado esperado: ✅ ÉXITO - Supervisor creado\n\n";
...
echo "Resultado esperado: ❌ ERROR - 'The institucion id field is required when rol is supervisor.'\n\n";
